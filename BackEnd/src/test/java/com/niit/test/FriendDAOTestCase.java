...
public class FriendDAOTestCase
{
	...
	{
		List<Friend> friendList=friendDAO.showFriendList("niit");
	...
	{
		List<UserDetail> listUserDetail=(List<UserDetail>)friendDAO.showSuggestedFriend("niit");
